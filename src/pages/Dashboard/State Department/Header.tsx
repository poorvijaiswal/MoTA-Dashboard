...
const Header = () => {
  ...
  return (
    <div className="relative shadow-lg border-b border-slate-200 bg-white">
        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            <div className="flex items-center space-x-3">
              <div>
                <h1 className="text-2xl font-extrabold text-slate-900 tracking-tight drop-shadow-sm">VanSampada Portal</h1>
      ...
      <div className="bg-white/90 border-b border-slate-200 shadow-sm backdrop-blur-md">
